...
RSpec.describe User, type: :model do
  ...
  describe 'ユーザー新規登録' do
    ...
    context '新規登録できないとき' do
      ...
      it 'passwordの値とpassword_confirmationが一致しなければ登録できない' do
      ...
      it 'family_name_kanaがカタカナ以外では登録ができない' do
